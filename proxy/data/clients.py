...
<<<<<<< HEAD
        print('[PCP Bot] Users ini %s (ID:%i) di Blacklist!' % (l_my_username, handle.playerId))
        handle.send_crypto_packet(packetFactory.SystemMessagePacket("Anda di Blacklist dari PCP Network.", 0x1).build())
=======
